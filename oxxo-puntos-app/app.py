...
# la columna Estado Growth de la base de Operaciones y usa las coordenadas
# resueltas para cada operación desde su URL de Maps o sus respaldos.
...
# ============================================================== PAGE 2 ====
    ...
    if n_growth_subidos_sin_coordenadas:
        st.info(
            ...
            "coordenadas válidas desde su URL de Maps ni sus respaldos."
        )
